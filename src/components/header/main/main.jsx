...
const myproject = [
  ...
  {
    category: ["html", "css", "java"],
    link: "assets/imge-10.png",
    title: "Sowh Product",
    suptitle: "Make-a-creative-landing-page ",
    linkproject: "https://tarek-goher.github.io/Make-a-creative-landing-page/",
    linkgithub: "https://github.com/tarek-goher/Make-a-creative-landing-page.git",
    more:" https://github.com/tarek-goher/Make-a-creative-landing-page.git",
  },
  {
    category: ["html", "css", "java"],
  ...
  {
    category: ["html", "css", "java"],
    link: "assets/imge-11.png",
    title: "Check-Internet",
    suptitle:"It is a simple project that uses JS to find out if a user has internet or not",
    linkproject: "https://tarek-goher.github.io/Check-Internet/",
    linkgithub: "https://github.com/tarek-goher/Check-Internet.git",
    more:"https://github.com/tarek-goher/Check-Internet.git",
    ...
    <main id="Projects" className="flex">
      <section className="left-section  flex">
        ...
        <button
          ...
          className={active === "Component" ? "active" : null}
        >
           React & Component 
        </button>
      </section>
